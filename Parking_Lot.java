...
public class Parking_Lot {
   ...
   private String name;
    ...
    public Parking_Lot(String name, int capacity, String location, double parkingCharges, AutomatedSystem automatedSystem, DisplayBoard displayBoard) {
        this.name = name;
    ...
    public static void main(String[] args) {
        ...
        Parking_Lot myParkingLot = new Parking_Lot("MyParkingLot",100, "Sec-135,Noida",50,automatedSystem,displayBoard);
